module.exports = {
    ...
    async execute(message, args, cmd, client, discord){
        ...
        channel.setParent('869288759936552980');
        ...
        const reactionMessage = await channel.send('Thank you for contacting Virtuous Saint Officer Corps, we will be with you shortly!');
        try {
            // Lock the ticket, no messages by author sent anymore
